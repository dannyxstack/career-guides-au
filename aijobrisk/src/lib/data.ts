...
// 职业 URL 结构见 i18n.ts 的 hrefJob（语言第一级、国家末级：/{lang}/jobs/{slug}[/{cc}]）。
// 此处 jobHref 仅保留英文裸路径，供 riskmap-meta 等内部默认使用；页面链接一律走 i18n.hrefJob。
export function jobHref(slug: string, country?: string): string {
