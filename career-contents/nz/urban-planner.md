# Urban Planner — career analysis · New Zealand

**Occupation code: 232212 (ANZSCO)**
...
|---|---|---:|
| Bachelor's degree | 4 years | $50,000~$120,000 (Total undergraduate tuition, higher for international students) |
| Master's degree | 1.5-2 years | $40,000~$80,000 (Total master's tuition; some institutions offer 1-year programs) |
...
|---|---|---|---|
| IELTS Academic overall band 7.0 | IELTS | Required | Usually required for skilled migration; no band below 6.5. |
| New Zealand Planning Institute membership | New Zealand Planning Institute (NZPI) | Optional | Though not legally required, employers prefer NZPI members |
| New Zealand registered urban planner | NZPI | Optional | Must pass NZPI's registration assessment, beneficial for career development. |

---

## 3. Job demand / competition / intensity

**Job demand: high (★★★★☆).** National workforce approx. 3,000. New Zealand's urbanization continues, with strong demand for housing and infrastructure, and good employment prospects for urban planners. Especially in major cities like Auckland and Wellington, government projects and private developers both need planning professionals.
...
| Visa | Description |
|---|---|
| Subclass SMC (Skilled Migrant Category) | Based on the 6-point system, urban planners typically get 6 points; meet salary requirements and directly apply for residence. |
| Subclass Green List T1 (Green List Tier 1 (Direct Residence)) | Urban planners are on the Green List Tier 1, meeting twice the median wage (approximately $59,000) can directly apply for residency. |
| Subclass AEWV (Accredited Employer Work Visa) | For applicants who have a job offer from an accredited employer, can apply for residency after working for 2 years. |
...
**Q: What is the salary level for urban planners?**
A: Entry-level approx. NZD 55,000–75,000, mid-level NZD 75,000–100,000, senior NZD 100,000–140,000. Median salary for planners in NZ is about NZD 85,000, above the national average.

**Q: Is it easy for urban planners to immigrate to New Zealand?**
A: Relatively easy. This occupation is on Tier 1 of the Green List. Meeting the salary requirement (twice the median) allows direct residency application, or through the SMC 6-point system (qualifications + experience).

**Q: What are the career development paths for urban planners?**
A: Can advance to senior planner, planning manager, or specialize in transport planning, environmental planning, urban design, etc.; may transition to policy development or academic research.
