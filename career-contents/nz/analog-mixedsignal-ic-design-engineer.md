# 模拟/混合信号 IC 设计工程师（Analog / Mixed-Signal IC Design Engineer）职业分析 · 新西兰
...
**职位需求量：中等偏低（★★½☆☆）。** 全国从业人数约 300。在新西兰，全球芯片自主与 AI 加速需求外溢，模拟/混合信号 IC 设计工程师岗位稀缺、供给更少，资深人才紧俏、薪资位于电子工程高端。

| 平台 | 实时挂牌量（约） | 备注 |
|---|---:|---|
| Seek NZ | 5~40 个 | 模拟/混合信号 IC 设计工程师及相邻岗位（新西兰） |
| Trade Me Jobs | 10~50 个 | 模拟/混合信号 IC 设计工程师及相邻岗位（新西兰） |
| LinkedIn | 15~70 个 | 模拟/混合信号 IC 设计工程师及相邻岗位（新西兰） |
