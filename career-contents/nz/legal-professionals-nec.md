# Legal Professionals nec — career analysis · New Zealand
...
|---|---|---:|
| Bachelor of Laws (LLB). | 4 years | $50,000~$70,000 (New Zealand university tuition fees) |
| Graduate Diploma in Law (GDipLaw) | 1 year | $30,000~$45,000 (For students from non-legal backgrounds) |
| Professional legal training (Profs) | 1 year | $20,000~$30,000 (Includes internships and courses) |
...
|---|---|---|---|
| New Zealand practicing certificate as Barrister and Solicitor | New Zealand Law Society | Required | Must complete vocational training (Profs) and pass character checks |
| English proficiency proof (IELTS 4x7 or equivalent) | IELTS/TOEFL/PTE | Optional | Required for non-native English speakers |
| Licensed Conveyancer | Land Information New Zealand (LINZ) | Optional | Optional, but enhances competitiveness |

---

## 3. Job demand / competition / intensity

**Job demand: medium-high (★★★☆☆).** National workforce approx. 2,500. New Zealand's housing market is active, especially in Auckland and Christchurch, with sustained demand for property transfers. The number of practitioners is expected to grow modestly, but is subject to economic cycles.
...
| Visa | Description |
|---|---|
| Subclass SMC (Skilled Migrant Category) | Must meet occupation list requirements (Legal Professionals nec on ANZSCO list), apply through the six-point system. |
...
**Q: What is the average salary of a conveyancer in New Zealand?**
A: Junior: approximately NZD 55,000-75,000; intermediate: NZD 75,000-95,000; senior: up to NZD 100,000-140,000. Salary is affected by experience and region.

**Q: Can a conveyancer settle in New Zealand through skilled migration?**
A: Yes. This occupation is on the SMC occupation list and can be applied for under the 6-point system. You need to obtain New Zealand practising certification and meet language requirements.

**Q: What qualifications are needed to become a property conveyancer in New Zealand?**
A: Typically requires a Bachelor of Laws (LLB) or Graduate Diploma in Law (GDipLaw), and completion of professional training (Profs) to obtain a lawyer's practicing certificate.
