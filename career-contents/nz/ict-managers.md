# ICT Managers — career analysis · New Zealand
...
|---|---|---:|
| Bachelor's degree | 3 years | $40,000~$55,000 (Public universities such as the University of Auckland) |
| Master's degree | 1-2 years | $50,000~$70,000 (Accelerated course or professional master's degree) |
...
|---|---|---|---|
| IELTS 6.5 | IELTS | Required | English language requirements for immigration |
| Project Management Professional (PMP) certification | PMI | Optional | Although not mandatory, employers strongly prefer |
| Agile certification (CSM) | Scrum Alliance | Optional | Commonly used in IT projects |

---

## 3. Job demand / competition / intensity

**Job demand: high (★★★★☆).** National workforce approx. 3,200. New Zealand's digital government, health IT, and cloud migration projects are driving demand, with expected job growth of 10-15% over the next five years. Auckland and Wellington concentrate 60% of positions.
...
| Visa | Description |
|---|---|
| Subclass SMC (Skilled Migrant Category) | 6-point system, scored based on qualifications, work experience, and a New Zealand job offer |
...
**Who is suited**
- Technically skilled individuals with good communication and leadership skills.
...
**Q: What is the average annual salary for an IT Project Manager in New Zealand?**
A: Depending on experience, entry-level approx NZD 75k-95k, mid-level NZD 100k-130k, senior NZD 135k-170k.

**Q: Can IT project managers directly apply for residency through the Green List?**
A: Yes. IT Project Manager is on the Green List Tier 1; meeting the salary requirement (above median) allows direct residence application.
