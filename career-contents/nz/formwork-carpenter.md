# Formwork Carpenter — career analysis · New Zealand
...
|---|---|---:|
| Apprenticeship | 3-4 years | $0~$10,000 (On-the-job training; employer covers part of the cost) |
| Certificate course | 1-2 years | $5,000~$15,000 (Polytechnic institutes are eligible for student loans) |
| Pre-training | 6 months. | $2,000~$5,000 (Short introductory courses, some free) |
...
|---|---|---|---|
| New Zealand Certificate in Carpentry | Building and Construction Industry Training Organisation (BCITO) | Required | Core qualification, obtained after completing apprenticeship |
| Site Safety certificate | Site Safe | Required | Basic site safety requirements |
| Driver's license (Class 1) | NZ Transport Agency | Optional | Most construction sites require driving to commute |
| Scaffolding certificate or working at height certificate | Various training institutions | Optional | Not mandatory, but beneficial for promotion |

---

## 3. Job demand / competition / intensity

**Job demand: high (★★★★☆).** National workforce approx. 4,500. New Zealand's construction industry continues to grow, with strong demand for housing and infrastructure in cities like Auckland and Christchurch. Formwork carpenters are in long-term shortage, with steady job growth expected over the next decade and rising wages.
...
| Visa | Description |
|---|---|
| Subclass Green List T1 (Straight to Residence Visa) | Occupation on Green List Tier 1, can directly apply for residency without working first. |
...
**Q: What is the average annual salary for a formwork carpenter in New Zealand?**
A: Based on experience: entry-level approx. NZ$45,000-60,000; mid-level NZ$60,000-80,000; senior or lead hand up to NZ$80,000-100,000. Green List positions usually pay above median (approx. NZ$65,000).

**Q: How can formwork carpenters immigrate to New Zealand via the Green List?**
A: This occupation is on the Green List Tier 1 (Direct Residence), no need to work in New Zealand first; can directly apply for Straight to Residence Visa. Also eligible for residence after 2 years of work via AEWV.

**Q: What training or qualifications are needed to become a formwork carpenter?**
A: Usually complete an apprenticeship (3-4 years) to obtain a New Zealand Carpentry Certificate, or enter after a short certificate course. Must hold a safety certificate and driver's license.
