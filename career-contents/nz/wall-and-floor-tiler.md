# Wall and Floor Tiler — career analysis · New Zealand
...
|---|---|---:|
| Apprenticeship | 3-4 years | $2,000~$6,000 (Completed through industry organizations (e.g., BCITO), typically work and study concurrently, with tuition partially covered by the employer.) |
| Pre-training certificate | 6 months to 1 year | $3,000~$8,000 (Offered by institutes like Unitec, suitable for beginners with no background, but not mandatory.) |
...
|---|---|---|---|
| Site Safe Passport | Site Safe | Required | Required for site entry, half-day training. |
| New Zealand National Certificate in Wall and Floor Tiling (Level 4) | Building and Construction Industry Training Organisation (BCITO) | Optional | Industry-standard qualification, usually obtained through an apprenticeship, preferred by employers. |
| English language requirements (immigration) | Immigration-approved test (e.g., IELTS). | Optional | Skilled migration requires overall IELTS 6.5 or equivalent; Green List pathway may have lower requirements. |

---

## 3. Job demand / competition / intensity

**Job demand: high (★★★★☆).** National workforce approx. 2,400. New Zealand's construction industry continues to grow, especially in cities like Auckland and Christchurch, with new housing construction and renovation projects providing stable job opportunities for tilers. Demand is expected to remain strong over the next 5 years, but subject to economic cycles, competition is moderate.
...
| Visa | Description |
|---|---|
| Subclass Green List T1 (Straight to Residence Visa) | Wall and floor tilers are on the Green List Tier 1, meeting the occupation and relevant requirements allows direct residence application without prior work. |
| Subclass SMC (Skilled Migrant Category) | Can apply through Skilled Migrant Category, requires 6-point system (e.g., qualifications + work), currently a priority occupation. |
| Subclass AEWV (Accredited Employer Work Visa) | The most common work visa pathway: apply after obtaining a certified employer offer, and can transition to residence after gaining experience. |
...
**Q: How much do tile setters earn in New Zealand?**
A: Entry-level tiler annual income approx. NZD 45,000–55,000; mid to senior level can reach NZD 70,000–90,000; self-employed skilled workers earn more. Salary varies by region and experience.

**Q: How can a Chinese tiler immigrate to New Zealand?**
A: Tilers are on the Green List Tier 1 and can directly apply for residence, but need relevant qualifications or experience and pass New Zealand qualification recognition (e.g., NZQA assessment). Alternatively, they can first come to work via an Accredited Employer Work Visa (AEWV) and then transition to residence.

**Q: Do tilers need registration or a license in New Zealand?**
A: Tilers are not required to be registered, but holding a New Zealand National Certificate (Level 4) greatly enhances employment and immigration prospects. A site safety card is mandatory.
