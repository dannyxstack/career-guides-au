# Bank Worker — career analysis · New Zealand
...
|---|---|---:|
| High school / Foundation studies | 1 year | $0~$5,000 (Most banks require NCEA Level 2 or equivalent) |
| Diploma | 1 year | $8,000~$15,000 (E.g., New Zealand Bankers Association certificate, partial coverage) |
| Bachelor's degree | 3 years | $30,000~$45,000 (Business-related degree, not mandatory but beneficial for promotion) |
...
|---|---|---|---|
| Anti-money laundering training | Inside a bank | Required | Must complete after onboarding |
| No mandatory registration. | None | Optional | Bank tellers do not require registration, but employers may require basic financial certifications |
| Customer service certificate | ServiceIQ | Optional | Voluntarily obtained to enhance competitiveness |

---

## 3. Job demand / competition / intensity

**Job demand: medium (★★½☆☆).** National workforce approx. 8,000. New Zealand's banking sector is accelerating digital transformation, reducing demand for teller roles, but customer service and sales positions remain stable. Employment numbers are expected to decline slightly over the next 5 years, with moderate competition, mainly vacancies in remote areas or mid-sized banks.
...
| Visa | Description |
|---|---|
| Subclass AEWV (Accredited Employer Work Visa) | Requires employer sponsorship, working in this occupation, wage at median (approx. NZD 29.66/hour in 2024), eligible for a 3-year work visa |
| Subclass SMC (Skilled Migrant Category) | Theoretically possible, but wages must be 1.5 times the median (approx. NZD 44.49/hour) and the occupation must be at ANZSCO skill level 1-3; bank tellers are level 4, so usually not eligible. |
| Subclass Partner (Partner of a New Zealander Work Visa) | If you have a New Zealand spouse, you can work on a partner visa |
...
**Q: What is the average annual salary of bank tellers in New Zealand?**
A: In 2024, bank tellers earned an average annual salary of about NZ$47,000-55,000, with senior positions reaching up to NZ$90,000.

**Q: Can a bank clerk obtain New Zealand residency through skilled migration?**
A: Extremely difficult. This occupation is typically classified as ANZSCO Skill Level 4, which does not meet skilled migration requirements (requires levels 1-3). It can generally only be worked through an Accredited Employer Work Visa (AEWV) or a partner work visa.

**Q: What are the career prospects for bank tellers in New Zealand?**
A: Prospects are average; digitalization has reduced teller positions. However, transition to personal banking advisor, loan officer, or branch management is possible, requiring financial certifications.
