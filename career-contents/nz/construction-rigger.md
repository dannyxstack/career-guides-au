# Construction Rigger — career analysis · New Zealand
...
|---|---|---:|
| Apprenticeship | 3-4 years | $0~$5,000 (Paid apprenticeships are usually tuition-free but require certification exam fees) |
| Pre-employment certificate | 6 months. | $3,000~$6,000 (Such as NZTC's crane operation courses) |
| Advanced Certificate / Diploma | 1-2 years | $8,000~$15,000 (Depends on the school) |
...
|---|---|---|---|
| New Zealand Certificate in Construction Trades (Crane Operation) | BCITO | Required | Must pass theory + practical assessment |
| Work safety license (lifting coordinator) | WorkSafe NZ | Required | Requires passing an exam |
| IELTS 6.0 (migration requirement) | IELTS | Optional | Language requirements for skilled migration |

---

## 3. Job demand / competition / intensity

**Job demand: high (★★★★☆).** National workforce approx. 1,500. Demand driven by infrastructure and renewable energy projects (e.g., wind farms) in New Zealand. Strong job growth expected over next 5 years, especially in Canterbury and Waikato. Shortage unlikely to ease in short term.
...
| Senior (7+ years) | $85,000~$110,000 | Managerial level can reach 120k+. |
...
| Visa | Description |
|---|---|
| Subclass Green List T1 (Straight to Residence Visa) | Direct Residence Visa, no need to work for two years, eligible for Green List Tier 1 requirements |
...
- People who lack patience or expect rapid promotion to office positions

---

## 8. FAQ

**Q: What is the starting salary for a crane/rigger in New Zealand?**
A: Entry-level starting salary about NZ$50,000-65,000 per year, hourly NZ$25-32; senior can reach NZ$85,000-110,000.

**Q: Can crane operators/riggers immigrate to New Zealand via the Green List?**
A: Yes. This occupation is on the Green List Tier 1; meeting the requirements allows direct application for a residence visa.
