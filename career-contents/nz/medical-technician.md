# Medical Technician — career analysis · New Zealand

**Occupation code: 311299 (ANZSCO)**
...
|---|---|---:|
| New Zealand Certificate (Level 4) or Diploma (Level 5) | 1-2 years | $15,000~$30,000 (Public polytechnics (e.g., Unitec, Otago Polytechnic) tuition fees; international students additional) |
| Overseas qualification assessment (NZQA) | 1-3 months. | $500~$1,000 (Assessment fee, requires English translation) |
...
|---|---|---|---|
| National Diploma in Applied Science (Medical Laboratory) | New Zealand Institute of Technology | Required | Required by most employers and a prerequisite for registering as a Medical Laboratory Technician |
| Medical laboratory technician registration in New Zealand | Medical Sciences Council of New Zealand | Required | Must pass exams and assessments; a statutory requirement for clinical laboratory work |
| IELTS overall score 6.5 | IELTS | Optional | Registration and migration language requirements: no band below 6.0 |

---

## 3. Job demand / competition / intensity

**Job demand: medium (★★½☆☆).** National workforce approx. 3,500. With New Zealand's aging population and growing healthcare demand, medical tech support roles are stable. But not on Green List or shortage lists; moderate competition, mainly in public hospitals and private labs. Immigration quotas limited, advise targeting district health board jobs.
...
| Visa | Description |
|---|---|
| Subclass AEWV (Accredited Employer Work Visa) | For overseas applicants with an offer from an accredited employer; not a direct immigration pathway, can accumulate work experience. |
| Subclass SMC (Skilled Migrant Category) | Theoretically, if ANZSCO skill level and median wage requirements are met, can apply, but in practice, due to the occupation not being on the priority list, EOI selection rate is low |
...
**Q: What is the salary level for Medical Technicians in New Zealand?**
A: Entry-level annual salary approx. NZ$45,000-55,000, mid-level $55,000-70,000, senior $70,000-85,000. Lower than New Zealand median salary (approx. $60,000), but more stable than retail, etc.

**Q: Can medical technicians obtain New Zealand residency through skilled migration?**
A: Direct Skilled Migration (SMC) is difficult because the occupation is not on the Green List or skills shortage list. Common path is to first hold an AEWV job, meet salary and duration requirements, then switch to SMC, but competition is high.

**Q: How to have an overseas qualification certified as a medical technician in New Zealand?**
A: Requires assessment by the New Zealand Qualifications Authority (NZQA), and may need to complete supplementary courses. Then apply for registration with the Medical Sciences Council, including IELTS 6.5 and clinical exams.
