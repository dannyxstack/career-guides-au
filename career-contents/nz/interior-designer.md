# Interior Designer — career analysis · New Zealand
...
|---|---|---:|
| Bachelor's Degree (Level 7) | 3 years | $70,000~$95,000 (Annual tuition for undergraduate design programs in New Zealand is approx NZD 23,000-32,000.) |
| Master's degree (Level 9) | 1-2 years | $55,000~$75,000 (Total tuition for master's program, can count as qualification points) |
...
|---|---|---|---|
| Bachelor of Interior Design | Massey University / Wellington Institute of Technology, etc. | Required | Qualification assessment for immigration skills evaluation. |
| IELTS 6.5 with no band below 6 | IDP/BC | Required | Immigration language requirement |
| Member of the New Zealand Design Institute (DINZ) | DINZ | Optional | Not mandatory but enhances competitiveness |

---

## 3. Job demand / competition / intensity

**Job demand: medium-high (★★★★☆).** National workforce approx. 2,500. New Zealand's residential and commercial renovation market is growing steadily, with new projects continuously launched in Auckland, Christchurch, and Wellington. Post-pandemic, office space renovations and sustainable design demand are rising, with green building experience as a plus. Job opportunities are concentrated in design consultancies, architecture firms, and large developers.
...
| Visa | Description |
|---|---|
| Subclass Green List T2 (Work to Residence) | After working as an interior designer for 2 years, you can apply for residency, requiring a median hourly wage or above |
...
**Q: What is the salary level of interior designers in New Zealand?**
A: Entry level (0-3 years) annual salary approx. NZD 55,000-70,000, mid-level (3-6 years) approx. NZD 72,000-90,000, senior (6+ years) up to NZD 95,000-120,000. Salaries in Auckland are typically higher than in Christchurch.

**Q: Can interior designers apply for immigration via the Green List?**
A: Yes. Interior designers are on Tier 2 of the Green List, and after 2 years in the role, can apply for a Work to Residence visa. Alternatively, they can apply through the Skilled Migrant Category (6-point system), requiring 6 points from qualifications, salary, and work experience.

**Q: Do interior designers in New Zealand need registration or a license?**
A: Currently, New Zealand law does not mandate interior designer registration, but qualifications (e.g., bachelor's degree) and DINZ membership enhance competitiveness. Skill assessment is required for immigration, usually requiring a Level 7 bachelor's degree or higher.
