# Painter and Decorator — career analysis · New Zealand
...
|---|---|---:|
| Apprenticeship training | 3-4 years | $0~$8,000 (Most apprenticeship training is government-funded, with low costs) |
| Certificate course | 6–12 months | $5,000~$15,000 (Private training institutions offer short-term courses) |
...
|---|---|---|---|
| New Zealand National Certificate in Painting and Decorating (L3/L4) | New Zealand Qualifications Authority (NZQA) | Required | Obtained through apprenticeship training or work experience, mandatory |
| Health and safety certificate | Organizations like Site Safe | Required | Required for work, proof of safety knowledge |

---

## 3. Job demand / competition / intensity

**Job demand: medium-high (★★★½☆).** National workforce approx. 10,000. New Zealand's construction industry continues to grow, with residential renovations and new builds driving demand for painters. Job opportunities are expected to be stable over the next five years, especially in Auckland, Wellington, and Christchurch.
...
| Visa | Description |
|---|---|
| Subclass AEWV (Accredited Employer Work Visa) | Applicable to painters with accredited employer sponsorship, meeting salary requirements (median $29.66/hour), can transition to residence |
...
**Q: What is the salary level for painters in New Zealand?**
A: Entry-level hourly wage ~22-26 NZD, mid-level 26-33 NZD, senior up to 35+ NZD. Self-employed earn more.

**Q: How can painters immigrate to New Zealand?**
A: Main pathway: obtain a two-year AEWV with accredited employer sponsorship, then apply for residency; or meet salary requirements through SMC 6-point system (requiring work experience points).

**Q: What certificates are needed?**
A: Requires New Zealand National Certificate in Construction (Painting and Decorating) L3 or L4, plus health and safety certificate
