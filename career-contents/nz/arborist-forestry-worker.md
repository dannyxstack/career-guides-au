# Arborist / Forestry Worker — career analysis · New Zealand
...
|---|---|---:|
| New Zealand National Certificate (Arborist) | 1-2 years | $5,000~$15,000 (New Zealand Institutes of Technology (e.g., Unitec) or private training providers, with higher fees for international students) |
| New Zealand National Diploma (Urban Forestry/Tree Management) | 2 years | $15,000~$30,000 (Polytechnic (e.g., Southern Institute of Technology)) |
...
|---|---|---|---|
| New Zealand National Certificate - Arborist (Level 3/4). | NZQA-recognised training provider | Required | Essential for entry-level arborists, covering safe pruning, climbing, and tree assessment |
| New Zealand Arborist Registration (NZAA) | New Zealand Arboricultural Association (NZAA) | Optional | Not mandatory but preferred by employers, required for senior roles |
| New Zealand driver's license (Class 2 or heavy vehicle) | NZ Transport Agency | Optional | Often need to drive trucks or aerial work platforms at work |
| Unit Standard 15757 (Tree Risk Assessment) | NZQA | Optional | Professional standard for advanced arborists assessing tree safety |

---

## 3. Job demand / competition / intensity

**Job demand: high (★★★★☆).** National workforce approx. 2,500. Demand for arborists in New Zealand is growing due to urban greening, biosecurity (e.g., controlling fungal diseases), and storm-related tree management, with an expected annual increase of over 5% in the next five years, especially in major cities like Auckland. Forestry workers are driven by sustainable logging and carbon credit projects, but face significant seasonal fluctuations in remote areas.
...
| Visa | Description |
|---|---|
| Subclass Green List T1 (Green List Straight to Residence) | Arborists are on the Green List direct residence occupation list; meeting the median hourly wage (NZ$33.08/h) allows direct residence application without working for two years. |
...
**Q: What is the salary level for arborists in New Zealand?**
A: Junior arborist annual salary approx. NZD 50,000-70,000, intermediate NZD 70,000-95,000, senior (e.g., consultant or team leader) up to NZD 95,000-130,000. Overtime and piecework can significantly increase income.

**Q: Is it easy for arborists to immigrate to New Zealand under skilled migration?**
A: Arborists are on the Green List Tier 1 direct residence pathway; meeting the median wage (approx. $33.08/h) allows fast-track immigration without a two-year wait. This is one of the most immigration-friendly occupations in New Zealand.
