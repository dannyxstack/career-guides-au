# Cartographers and Photogrammetrists — career analysis · United States

**Occupation code: 17-1021 (SOC)**
...
|---|---|---:|
| Bachelor's degree | 4 years | $20,000~$60,000 (Public university tuition range (annual), private higher) |
| Master's degree | 2 years | $30,000~$80,000 (Public university tuition range (annual), private higher) |
...
|---|---|---|---|
| GIS Professional (GISP) certification | GIS Certification Institute (GISCI) | Optional | Voluntary certification to enhance employability |
| Photogrammetrist certification. | American Society for Photogrammetry and Remote Sensing (ASPRS) | Optional | Voluntary certification for photogrammetry |

---

## 3. Job demand / competition / intensity

**Job demand: medium-high (★★★½☆).** National workforce approx. 14,000. According to the US Bureau of Labor Statistics, employment growth from 2023 to 2033 is projected at 8%, above the average for all occupations. Demand for geographic information systems (GIS) and cartography technology continues to grow, especially in government, surveying services, and technical consulting.
...
|---|---:|---|
| Median salary | $81,390 | National full-time annual salary median (Source: US BLS OES 2025) |
| Entry level (0–3 years) | $45,000~$65,000 | Starting salary depends on region and educational background |
...
| average salary | $86,690 | National full-time annual salary mean (Source: US BLS OES 2025) |
...
| Visa | Description |
|---|---|
| Subclass H-1B (H-1B Specialty Occupations) | Applicable to professional positions requiring a bachelor's or higher degree, including cartographers and photogrammetrists |
| Subclass EB-2 (Employment-Based Second Preference) | Applicable to immigrants with advanced degrees or special abilities, common in this occupation |
...
**Q: What is the salary level for cartographers?**
A: According to BLS 2023 data, median annual wage about $73,000. Entry-level around $45,000-65,000, senior positions up to $130,000+.

**Q: What are common visa pathways for cartographers to immigrate to the U.S.?**
A: Common paths include H-1B work visa requiring bachelor's or higher degree; and EB-2/EB-3 employment-based green cards requiring employer sponsorship and PERM labor certification. Canadian or Mexican citizens can use TN visa.
