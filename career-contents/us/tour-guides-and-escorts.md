# Tour Guides and Escorts — career analysis · United States

**Occupation code: 39-7011 (SOC)**
...
|---|---|---:|
| High school diploma or equivalent | 0 years | $0~$0 (Usually high school diploma sufficient, no university degree required) |
| Specialist or certificate training | 1 year | $2,000~$10,000 (Tourism management or tour guide certificate course) |
| Bachelor's degree | 4 years | $20,000~$60,000 (Majors like tourism, history, foreign languages are not required but helpful for competitiveness) |
...
|---|---|---|---|
| Tour guide license (optional) | Local tourism bureau or industry organization | Optional | Some cities or national parks require a tour guide license. |
| First aid certificate | American Red Cross | Optional | Recommended to have, enhances employer trust. |
| Driver's license | State motor vehicle department | Optional | If driving a vehicle for tours, need a standard driver's license or commercial driver's license |

---

## 3. Job demand / competition / intensity

**Job demand: medium (★★½☆☆).** National workforce approx. 39,000. The recovery of US tourism is driving demand for tour guides, but job growth is slow (annual growth rate of about 3%) and the competition is fierce. There are more part-time positions and limited full-time opportunities.
...
| Visa | Description |
|---|---|
| Subclass H-1B (Specialty Occupations) | Tour guides generally do not meet H-1B specialty occupation requirements and rarely receive sponsorship |
| Subclass O-1 (Individuals with Extraordinary Ability) | Exceptional tour guides (e.g., internationally renowned) may apply for the O-1 visa, but the threshold is extremely high |
| Subclass Green Card (PERM) (Employment-Based Green Card) | Due to non-professional occupation, employers find it difficult to sponsor green card through PERM labor certification |
...
A: Median annual salary for US tour guides is about $35,000, but heavily affected by season and tips; entry-level positions may earn below $25,000.

**Q: Can tour guides immigrate to the US via work visa?**
A: Tour guides typically do not qualify for H-1B professional occupation requirements, employer-sponsored green cards are very difficult, and immigration paths are extremely limited.

**Q: What is the future outlook for tour guides?**
A: Affected by automation (e.g., audio guides) and online travel content, traditional tour guide demand grows slowly, but personalized experience guides still have a market.
