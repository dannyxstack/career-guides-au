# 模拟/混合信号 IC 设计工程师（Analog / Mixed-Signal IC Design Engineer）职业分析 · 美国

**职业代码：17-2072 – Analog / Mixed-Signal IC Design Engineer。**
...
**职位需求量：中等偏低（★★½☆☆）。** 全国从业人数约 300。在美国，全球芯片自主与 AI 加速需求外溢，模拟/混合信号 IC 设计工程师岗位稀缺、供给更少，资深人才紧俏、薪资位于电子工程高端。

| 平台 | 实时挂牌量（约） | 备注 |
|---|---:|---|
| Indeed US | 5~40 个 | 模拟/混合信号 IC 设计工程师及相邻岗位（美国） |
| Glassdoor | 10~50 个 | 模拟/混合信号 IC 设计工程师及相邻岗位（美国） |
| LinkedIn | 15~70 个 | 模拟/混合信号 IC 设计工程师及相邻岗位（美国） |
...
**发展前景：很好（★★★★☆）。** 美国 AI 加速器与低功耗/模拟设计为主线，掌握 RTL/时序/版图的工程师稀缺；AI 辅助有限，架构与流片责任高度专业。
**AI替代风险：极低（★☆☆☆☆）。**
...
**问：美国模拟/混合信号 IC 设计工程师工资多少？**
答：初级约 $120,000~$155,000；资深约 $200,000~$250,000（USD）。薪资随地区、行业与项目而定，具体见薪资表。

**问：模拟/混合信号 IC 设计工程师在美国需求怎样？**
答：在美国，全球芯片自主与 AI 加速需求外溢，模拟/混合信号 IC 设计工程师岗位稀缺、供给更少，资深人才紧俏、薪资位于电子工程高端。
