# Property, Real Estate, and Community Association Managers — career analysis · United States

**Occupation code: 11-9141 (SOC)**
...
|---|---|---:|
| Bachelor's degree | 4 years | $40,000~$80,000 (Public university tuition; private is higher) |
| Associate degree or certificate | 2 years | $15,000~$30,000 (Community college or technical school) |
...
|---|---|---|---|
| Real estate agent license | Real estate commissions in each state | Optional | Usually need to complete a pre-licensing course and pass an exam |
| Certified Property Manager (CPM) | IREM | Optional | Offered by the International Real Estate Management Association to enhance competitiveness |
| Certified Manager of Community Associations (CMCA). | CAI | Optional | Offered by community associations; advantageous for HOA management |

---

## 3. Job demand / competition / intensity

**Job demand: medium (★★½☆☆).** National workforce approx. 370,000. The US property management industry is projected to grow 5% from 2022 to 2032, about the average for all occupations. Population growth and real estate demand drive employment, but economic fluctuations may affect opportunities.
...
| average salary | $83,710 | National full-time annual salary mean (Source: US BLS OES 2025) |
...
| Visa | Description |
|---|---|
| Subclass H-1B (H-1B Specialty Occupations) | Suitable for managers with a bachelor's degree in a related field (e.g., business administration), but slots are limited. |
| Subclass EB-2 (Employment-Based Second Preference (EB-2)) | Requires advanced degree or exceptional ability; real estate management may be considered a professional position, but application requires employer sponsorship. |
...
**Q: What is the salary for a property manager?**
A: Entry-level: approximately USD 45,000-60,000, mid-level USD 60,000-85,000, senior USD 85,000-120,000, depending on experience and location.

**Q: How can international individuals immigrate to the US through this occupation?**
A: Typically requires an H-1B visa, but slots are tight; or via L-1 intracompany transfer. Green card requires employer-sponsored PERM, which is difficult.

**Q: What is the career path for a property manager?**
A: Start as assistant or leasing agent, progress to property manager, regional manager, then to portfolio management or vice president.
