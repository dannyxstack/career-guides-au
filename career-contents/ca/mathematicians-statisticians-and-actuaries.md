# Mathematicians, statisticians and actuaries — career analysis · Canada

**Occupation code: 21210 (NOC)**

Mathematicians, statisticians, and actuaries in Canada use mathematical and statistical methods to solve practical problems in finance, insurance, government, and research, involving risk assessment, data analysis, and predictive modeling.
...
|---|---|---:|
| Bachelor's degree | 4 years | $30,000~$60,000 (Average annual undergraduate tuition at Canadian universities) |
| Master's degree | 2 years | $20,000~$40,000 (Average annual tuition for master's degree) |
...
|---|---|---|---|
| Bachelor's degree in mathematics or statistics. | Canadian universities | Required | Minimum requirements |
| Actuary certification | Canadian Institute of Actuaries (CIA) | Optional | Obtain qualification as Associate or Fellow of the Institute of Actuaries through a series of exams |
| Statistician certification | Statistical Society of Canada (SSC) | Optional | Eligible to apply for Accredited Statistician title |

---

## 3. Job demand / competition / intensity

**Job demand: high (★★★★☆).** National workforce approx. 15,000. Job prospects in mathematics and statistics in Canada are good, with big data and AI driving demand growth. Actuaries are particularly sought after in insurance companies and consulting firms, while government and non-profit organizations also need statistical analysts.
...
|---|---:|---|
| Median salary | $106,080 | National full-time annual salary median (Source: Canada Job Bank, 2021 Census) |
...
A: Actuary starting salary approx. CAD 60,000-80,000, senior actuary can reach over CAD 150,000, chief actuary up to CAD 200,000.

**Q: How can statisticians immigrate to Canada?**
A: Statistician is a NOC A occupation; can apply for Express Entry through Federal Skilled Worker (FSW) or Canadian Experience Class (CEC), or apply for provincial nomination.

**Q: What qualifications are needed to become an actuary?**
A: Typically requires a bachelor's degree in actuarial science or a related field, and passing the actuarial society exams; some positions require a master's degree.
