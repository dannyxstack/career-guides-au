# Drafter (CAD Operator) — career analysis · South Korea

**Occupation code: 15914 (KECO)**
...
|---|---|---:|
| Associate's Degree (2-year) | 2 years | $4,000,000~$8,000,000 (Public university standard; private universities may be more expensive) |
| Associate's Degree (3-year) | 3 years | $6,000,000~$12,000,000 (Evening and online programs available) |
...
|---|---|---|---|
| Computer Application Machining Craftsman | Human Resources Development Service of Korea | Optional | Basic CAD for mechanical fields |
| Computer Application Architectural Drafting Craftsman | Human Resources Development Service of Korea | Optional | CAD for architectural fields |
| ATC (AutoCAD Certified) Certification | Autodesk | Optional | Internationally recognized, highly preferred by employers |

---

## 3. Job demand / competition / intensity

**Job demand: medium-high (★★★☆☆).** National workforce approx. 65,000. Due to digital transformation in Korea's manufacturing and construction sectors, demand for advanced CAD personnel persists, but simple drafting tasks are declining due to automation. Proficiency in 3D modeling and BIM is becoming essential.
...
**Q: What is the starting salary for a drafter?**
A: For small businesses, annual salary is 24–32 million KRW; larger companies or specialized design firms may offer more.

**Q: Can foreigners work as drafters in Korea?**
A: Possible with an E-7 visa, but degree and experience requirements must be met, and Korean language skills are advantageous.

**Q: Is there a high risk of AI replacing drafter jobs?**
A: Yes, simple 2D drafting is at high risk of automation, but advanced tasks like 3D modeling and BIM are enhanced by AI assistance.
