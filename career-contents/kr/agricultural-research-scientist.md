# Agricultural Research Scientist — career analysis · South Korea

**Occupation code: 12213 (KECO)**
...
|---|---|---:|
| Bachelor's Degree | 4 years | $4,000,000~$8,000,000 (Annual tuition fee: lower at public universities, higher at private universities) |
| Master's Degree | 2 years | $5,000,000~$10,000,000 (Annual tuition fee: research funding may be available) |
...
|---|---|---|---|
| Degree in Agriculture | University | Required | Majors such as agronomy, horticulture, and plant biotechnology are required |
| Research Experience | Research Institute | Optional | Experience in publishing papers and participating in projects is important |

---

## 3. Job demand / competition / intensity

**Job demand: medium (★★½☆☆).** National workforce approx. 2,500. Employment is stable due to the expansion of smart farms and increased research demand for climate change response, but the number of jobs is limited due to the nature of research positions.
...
**Q: What is the starting salary for an agricultural research scientist?**
A: For entry-level researchers, pre-tax annual salary is around 30-40 million KRW, with differences between national/public and private institutes.

**Q: What visa does a foreigner need to work as an agricultural research scientist in Korea?**
A: The E-7 (Specific Activities) visa is common, requiring a relevant bachelor's degree and research experience.

**Q: Can one become a researcher without a master's degree?**
A: Possible, but a master's degree or higher is advantageous for research positions, and most research institutes require a master's degree.
