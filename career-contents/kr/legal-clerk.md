# Legal Clerk — career analysis · South Korea

**Occupation code: 22201 (KECO)**
...
|---|---|---:|
| High school diploma | 0 years | $0~$0 (Minimum education requirement, no additional cost) |
| Associate degree in law-related field | 2 years | $6,000,000~$12,000,000 (Based on tuition, lower for public institutions) |
| Bachelor's degree in law | 4 years | $15,000,000~$30,000,000 (Based on tuition, higher for private institutions) |
...
|---|---|---|---|
| Paralegal/Notary Certificate | Notary Examination Management Committee | Optional | Allows independent work, advantageous for employment |
| Computerized Accounting Operator | Korea Productivity Center | Optional | Useful for accounting office assistance |
| Computer Literacy | Korea Chamber of Commerce and Industry | Optional | Demonstrates office skills |

---

## 3. Job demand / competition / intensity

**Job demand: medium-high (★★★☆☆).** National workforce approx. 78,000. Demand for legal services is stable, but simple tasks are expected to decrease due to office automation. Demand for skilled professionals will remain.
...
**Q: What is the average salary of a legal assistant?**
A: For entry-level, it is about 24 to 30 million won before tax, and with experience, it can reach over 40 million won.

**Q: Can a foreigner work as a legal assistant?**
A: It is possible with an E-7 visa, but legal expertise and Korean language skills are required, and it is generally difficult. Holders of F-4 (Overseas Korean) or F-2 (Residence) visas have an advantage.

**Q: Can a legal assistant become a lawyer?**
A: You must graduate from law school and pass the bar exam separately; field experience can be helpful.
