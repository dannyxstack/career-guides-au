# Flight Attendant — career analysis · South Korea

**Occupation code: 52211 (KECO)**
...
|---|---|---:|
| Associate degree (2-year) | 2 years | $6,000,000~$12,000,000 (Varies by national/private institution) |
| Bachelor's degree (4-year) | 4 years | $20,000,000~$40,000,000 (Higher including tuition and living expenses) |
...
|---|---|---|---|
| Completion of flight attendant training course | Airlines or educational institutions | Optional | Not mandatory but advantageous for hiring |
| English proficiency certification such as TOEIC | ETS, etc. | Optional | Often requires a minimum score of 700 |

---

## 3. Job demand / competition / intensity

**Job demand: medium (★★½☆☆).** National workforce approx. 15,000. Due to recovery in air travel demand after COVID-19, hiring has increased, but the job outlook is average due to sensitivity to economic fluctuations and intense competition.
...
**Q: What is the starting salary for a cabin crew member?**
A: For entry-level, approximately KRW 30 million to 40 million (annual pre-tax), with additional allowances based on flight hours and experience.

**Q: Can foreigners work as cabin crew in Korea?**
A: Possible with an E-7 visa, but Korean language skills and the airline's own standards must be met, and it is very limited.

**Q: Is it easy to transition from flight attendant to other occupations?**
A: It is possible to transition to airline ground staff, hotels, tourism, etc. using service and safety experience, but there is competition.
