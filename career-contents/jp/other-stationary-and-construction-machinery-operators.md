# Other Stationary and Construction Machinery Operators — career analysis · Japan

**Occupation code: 649 (JSCO)**
...
|---|---|---:|
| No specific education required, emphasis on practical experience | 0 years | $0~$0 (Education not required; training and courses have separate costs) |
| Training and licensing for construction machinery operation | 1-2 months | $50,000~$200,000 (Vehicle-type construction machinery operation skill training, etc.) |
...
|---|---|---|---|
| Vehicle-type construction machinery operation skill training completion | Prefectural Labor Bureau Director Registered Training Institution | Required | Required per machine type |
| Crane and Derrick Operator License | Ministry of Health, Labour and Welfare | Optional | Essential for crane operation |

---

## 3. Job demand / competition / intensity

**Job demand: high (★★★★☆).** National workforce approx. 170,000. Demand for construction machinery operators remains steady mid-term due to domestic public works and aging infrastructure renewal. Labor shortage persists, but automation is gradually emerging.
...
| Senior (10+ years) | $4,800,000~$6,500,000 | Higher income possible as site supervisor |
...
A: Entry-level: ¥2.8-3.6M, mid-level: ¥3.6-4.8M, veteran: ¥4.8-6.5M. Varies with overtime and qualifications.

**Q: Can foreigners work here?**
A: Possible under Specified Skilled Worker (i) (Construction) or Technical Intern Training. Japanese proficiency and skill test required.

**Q: Will automation reduce jobs?**
A: Some tasks are being automated, but complex on-site judgment requires humans, so demand remains.
