# Production Site Clerk — career analysis · Japan

**Occupation code: 271 (JSCO)**
...
|---|---|---:|
| High School | 3 years | $0~$0 (After compulsory education, public high school tuition is effectively free.) |
| Vocational School (Business) | 2 years | $1,000,000~$2,000,000 (When studying production management or bookkeeping.) |
...
|---|---|---|---|
| Nissho Bookkeeping Level 2 | The Japan Chamber of Commerce and Industry | Optional | Useful for cost management and inventory valuation. |
| Production Management Operations Certification | Japan Production Management Association | Optional | Proof of knowledge in production planning and process control. |
| MOS (Microsoft Office Specialist) | Microsoft | Optional | Proof of skills in Excel and Access. |

---

## 3. Job demand / competition / intensity

**Job demand: high (★★★★☆).** National workforce approx. 200,000. As manufacturing digitization progresses, clerical work is becoming systemized, but there is persistent demand for tasks requiring on-site coordination and interpersonal skills.
...
| Intermediate (3-7 years) | $3,500,000~$4,500,000 | Production management system operation skills are factored in. |
...
**Q: What is the salary level for production site clerks?**
A: Annual income varies by experience and company size; entry-level is about 2.8–3.5 million JPY, mid-level 3.5–4.5 million JPY. It is average for clerical jobs in manufacturing.

**Q: Is it possible for foreigners to work in this occupation?**
A: For the Engineer/Specialist in Humanities/International Services visa, a university degree or work experience is required, and purely clerical roles may be difficult. Combining with manufacturing sites may allow Specified Skilled Worker (i), but it is limited.
