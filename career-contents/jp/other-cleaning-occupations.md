# Other Cleaning Occupations — career analysis · Japan

**Occupation code: 719 (JSCO)**
...
|---|---|---:|
| Compulsory education | None | $0~$0 (No educational background required) |
| Vocational training | 3 months | $50,000~$100,000 (Hello Work or private cleaning courses) |
| Vocational school | 1 year | $500,000~$1,000,000 (Building Cleaning Course (optional)) |
...
|---|---|---|---|
| Special training (e.g., aerial work platforms) | Business operator | Required | Required for specific tasks |
| Building Cleaning Technician | Ministry of Health, Labour and Welfare | Optional | Skill certification, graded |
| Cleaning Work Supervisor | General Incorporated Association Japan Building Cleaning Association | Optional | Advantageous for site management |

---

## 3. Job demand / competition / intensity

**Job demand: high (★★★★☆).** National workforce approx. 1,200,000. Demand is steady due to aging population and labor shortages. This is a target field for Specified Skilled Worker status, with increasing acceptance of foreign workers.
...
A: For entry-level: ¥2.5–3.5 million, mid-level: ¥3.5–4.5 million, management: ¥5 million or more.

**Q: Can foreigners work here?**
A: Work is possible under Specified Skilled Worker (i) or skilled visa. Japanese language ability is required.

**Q: Are there paths to career advancement?**
A: Gain qualifications and field experience, then advance to management or start your own business. A Building Cleaning Technician certification is useful.
