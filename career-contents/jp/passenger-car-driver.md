# Passenger Car Driver — career analysis · Japan

**Occupation code: 612 (JSCO)**
...
|---|---|---|---|
| Ordinary Class 2 Driver's License | Prefectural Public Safety Commission | Required | Required for commercial taxi driving |
| Geographical Exam (Taxi) | Each prefecture's taxi association | Optional | Tests regional geography knowledge; recommended |
| Care Transport Worker Training | Each local government | Optional | For welfare taxis; optional but advantageous |

---

## 3. Job demand / competition / intensity

**Job demand: high (★★★★☆).** National workforce approx. 350,000. The taxi industry is facing serious aging and labor shortages; while not covered by Specified Skilled Worker status, securing domestic labor remains a challenge. Long-term impact from autonomous driving.
...
| Intermediate (3-10 years) | $4,000,000~$5,500,000 | Commission increases with experience |
...
**Q: What is the annual income like?**
A: First year around 3-4 million yen, with experience 5-7 million yen possible, but varies greatly due to commission-based system.

**Q: How can foreigners become taxi drivers in Japan?**
A: Currently not covered by Specified Skilled Worker visa, and Engineer/Specialist in Humanities/International Services visa is difficult to obtain for driving jobs. Requires existing status like permanent resident or spouse of Japanese national.

**Q: Are there career advancement opportunities?**
A: By obtaining a transportation management qualification, you can aim for management positions at branch offices or executive roles at taxi companies.
