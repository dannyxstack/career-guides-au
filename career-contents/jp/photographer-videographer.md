# Photographer, Videographer — career analysis · Japan

**Occupation code: 225 (JSCO)**
...
|---|---|---:|
| Vocational school (Photography/Video) | 2 years | $1,500,000~$3,000,000 (Tuition varies significantly by school) |
| University (Art/Film) | 4 years | $2,500,000~$5,000,000 (Varies between national/public and private) |
...
|---|---|---|---|
| Skills Test (Photography) | Ministry of Health, Labour and Welfare | Optional | Not required but boosts credibility |
| Color Coordinator Certification | Sponsored by MEXT | Optional | Advantageous as foundation for art/design |

---

## 3. Job demand / competition / intensity

**Job demand: medium-high (★★★½☆).** National workforce approx. 82,000. Demand is stable, but freelance competition is fierce; AI-driven automated editing may replace some tasks.
...
**Q: What is the average annual income of photographers and videographers?**
A: The average is about 4-5 million yen, but it varies greatly depending on freelancing and specialization; top earners can exceed 10 million yen.

**Q: What visa do foreigners need to work as photographers in Japan?**
A: Generally, an 'Engineer/Specialist in Humanities/International Services' visa is required, with expertise in photography/videography needed. For renowned artists, a 'Designated Activities (Art/Culture)' visa may be possible.
