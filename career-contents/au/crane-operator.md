...
| 资质 | 发证机构 | 备注 |
|---|---|---|
| High Risk Work Licence – Tower Crane (CT) | 各州 SafeWork / WorkSafe | 全国统一许可证，操作塔吊的强制执照 |
| High Risk Work Licence – Mobile Crane (C2/C6) | 各州 SafeWork / WorkSafe | 流动式起重机执照，按吨位分级 |
| Dogman Licence (DG) | 各州 SafeWork / WorkSafe | 配合起重作业的引导员资质，常作为入门路径 |
| Working at Heights Certificate | 认可RTO | 高空作业强制安全资质 |
...
起重机操作员是澳大利亚技术移民性价比最高的职业之一，持续短缺、薪资合理、PR路径清晰。
