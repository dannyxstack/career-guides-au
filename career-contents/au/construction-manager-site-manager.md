...
| 资质 | 发证机构 | 备注 |
|---|---|---|
| White Card（建设工地安全证） | TAFE / 认可RTO | 所有建设工地工作人员的法定要求 |
| Builder's Licence（建筑师执照） | 各州建筑监管局 | 独立承包建设项目（合同额超过 $20k）的法定要求 |
| Vetassess / AIPM 技能评估 | Vetassess / 澳洲项目管理研究院 | 技术移民的学历和经验评估 |
| PMP（Project Management Professional） | Project Management Institute | 大型基础设施项目经理的国际认可资质 |
...
| 签证类别 | 说明 |
|---|---|
| Subclass 482（TSS（Skills in Demand）） | 雇主担保，MLTSSL在列；大型承建商担保活跃 |
...
建筑工程师/工地经理是澳大利亚技术移民性价比最高的职业之一，持续短缺、薪资合理、PR路径清晰。
