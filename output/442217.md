...
**学习难度：低（★☆☆☆☆）。** 需完成 Certificate III in Electrotechnology Electrician（UEE30820），通过正式学徒制（Apprenticeship）取得。
...
| 资质 | 发证机构 | 备注 |
|---|---|---|
| 安保执照（Security Licence） | 各州安保监管局（NSW SLED/VIC LSCT等） | 澳洲所有从事安保工作的法定持牌要求 |
| Certificate II in Security Operations | TAFE / 认可RTO | 安保执照申请的前提培训资质 |
| 急救证书（First Aid/CPR） | St John Ambulance等认可机构 | 大多数安保公司的硬性要求 |
| 无犯罪记录（National Police Check） | 澳联邦警察或州警察局 | 安保执照申请的背景审查要求 |
...
**竞争度：很低（★☆☆☆☆）。** 供不应求，持牌电工找工作不难，尤其矿业和可再生能源方向。
...
| 签证类别 | 说明 |
|---|---|
| Subclass 482（TSS（Skills in Demand）） | 大型安保公司（Securecorp/G4S/Wilson Security）雇主担保 |
...
安全官/保安是澳大利亚技术移民性价比最高的职业之一，持续短缺、薪资合理、PR路径清晰。
