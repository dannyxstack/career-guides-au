"""重型设备操作工 (721211) Earthmoving Plant Operator — AU 2025-2026"""
...
TODAY = date.today()
OCCUPATION = {
    "anzsco_code": "721211", "anzsco_title": "Earthmoving Plant Operator",
    "category": "运输", "workforce_size": 25000, "shortage_listed": 1,
...
I18N_ZH = {"locale": "zh-CN", "name": "重型设备操作工",
    "summary": "重型设备操作工是澳洲运输行业的重要职业，需求稳定，具备相关资质即可入行。澳洲运输行业持续扩张，为专业人员提供良好的职业发展机会。",
    "forecast_note": "2025-2030年澳洲运输行业持续扩张，重型设备操作工需求保持稳定增长，具备相关认证和经验者就业前景良好。",
    "trend_summary": "数字化技术和专业认证要求持续提升，重型设备操作工须不断更新专业技能以适应行业变化。"}
I18N_EN = {"locale": "en", "name": "Earthmoving Plant Operator",
    "summary": "Earthmoving Plant Operator is an important role in Australia's 运输 sector with stable demand. The sector continues to expand, offering good career development opportunities for qualified professionals.",
    "forecast_note": "The Australian 运输 sector will continue to expand 2025-2030; demand for Earthmoving Plant Operators is expected to grow steadily for those with relevant certifications and experience.",
    "trend_summary": "Digitalisation and rising professional certification requirements mean Earthmoving Plant Operators must continuously update their skills to keep pace with industry changes."}
EDUCATION = [
...
QUALIFICATIONS = [
    {"qual_name": "Relevant qualification for Earthmoving Plant Operator", "issuer": "认可机构", "note": "入行基础", "is_mandatory": 1, "sort_order": 0},
...
SUITABILITY_FIT = ["对运输行业有热情者", "希望在澳洲稳定就业者", "具备相关学历背景者"]
SUITABILITY_UNFIT = ["不了解澳洲运输行业规范者", "不愿持续学习更新技能者"]
SOURCES = [
    {"source_name": "JSA", "content": "ANZSCO 721211 重型设备操作工数据", "url": "https://www.jobsandskills.gov.au/"},
    {"source_name": "Seek AU", "content": "薪资及岗位量", "url": "https://www.seek.com.au/"},
]
FAQS = [
    {"faq_type": "salary", "sort_order": 0, "question": "重型设备操作工在澳洲薪资如何？", "answer": "初级约AUD 5.8万~7.8万，中级8万~11万，高级/专科11.2万~15万，具体因城市和雇主而异。"},
    {"faq_type": "demand", "sort_order": 1, "question": "澳洲重型设备操作工好找工作吗？", "answer": "需求稳定，全澳各地均有职位，具备相关认证和经验者就业前景良好。"},
]
MARKDOWN = """# 重型设备操作工（Earthmoving Plant Operator）职业分析 · 澳大利亚

**职业代码：721211 – Earthmoving Plant Operator。**

重型设备操作工是澳洲运输行业的重要职业，需求稳定，具备专业资质后职业发展空间广阔。
