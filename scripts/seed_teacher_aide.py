"""教学助理 (422115) Teacher Aide — AU 2025-2026"""
...
TODAY = date.today()
OCCUPATION = {
    "anzsco_code": "422115", "anzsco_title": "Teacher Aide",
    "category": "教育", "workforce_size": 75000, "shortage_listed": 1,
...
I18N_ZH = {"locale": "zh-CN", "name": "教学助理",
    "summary": "教学助理是澳洲教育行业的重要职业，需求稳定，具备相关资质即可入行。澳洲教育行业持续扩张，为专业人员提供良好的职业发展机会。",
    "forecast_note": "2025-2030年澳洲教育行业持续扩张，教学助理需求保持稳定增长，具备相关认证和经验者就业前景良好。",
    "trend_summary": "数字化技术和专业认证要求持续提升，教学助理须不断更新专业技能以适应行业变化。"}
I18N_EN = {"locale": "en", "name": "Teacher Aide",
    "summary": "Teacher Aide is an important role in Australia's 教育 sector with stable demand. The sector continues to expand, offering good career development opportunities for qualified professionals.",
    "forecast_note": "The Australian 教育 sector will continue to expand 2025-2030; demand for Teacher Aides is expected to grow steadily for those with relevant certifications and experience.",
    "trend_summary": "Digitalisation and rising professional certification requirements mean Teacher Aides must continuously update their skills to keep pace with industry changes."}
EDUCATION = [
...
QUALIFICATIONS = [
    {"qual_name": "Relevant qualification for Teacher Aide", "issuer": "认可机构", "note": "入行基础", "is_mandatory": 1, "sort_order": 0},
...
SOURCES = [
    {"source_name": "JSA", "content": "ANZSCO 422115 教学助理数据", "url": "https://www.jobsandskills.gov.au/"},
    {"source_name": "Seek AU", "content": "薪资及岗位量", "url": "https://www.seek.com.au/"},
]
FAQS = [
    {"faq_type": "salary", "sort_order": 0, "question": "教学助理在澳洲薪资如何？", "answer": "初级约AUD 5.8万~7.8万，中级8万~11万，高级/专科11.2万~15万，具体因城市和雇主而异。"},
    {"faq_type": "demand", "sort_order": 1, "question": "澳洲教学助理好找工作吗？", "answer": "需求稳定，全澳各地均有职位，具备相关认证和经验者就业前景良好。"},
]
MARKDOWN = """# 教学助理（Teacher Aide）职业分析 · 澳大利亚

**职业代码：422115 – Teacher Aide。**

教学助理是澳洲教育行业的重要职业，需求稳定，具备专业资质后职业发展空间广阔。
